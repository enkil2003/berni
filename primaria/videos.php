                            ...
                            <div id="inner-content">
                                <div id="block">
                                    <article id="videos"><!-- Dinamic => [CONTENT] -->
                                        <h1 class="margin-bottom">Videos Nivel Primaria</h1>
                                        <?php

    // Obtengo los los videos disponibles
    $resultados = [];
$consulta = "SELECT * FROM videos WHERE escuela = 'primaria'";
...
if($resultados){
    ...
    echo '<h2>No se encontraron Videos.</h2>';
        ...
        <script src="js/primaria.js" type="text/javascript"></script>
    </body>
</html>
